...
public class HandleDialyXMLForecastDetails {
	...
	private String timeFrom = "from", timeTo = "to";
	...
	public HandleDialyXMLForecastDetails(String url) {
		this.urlString = url;
	}
			...
			while (event != XmlPullParser.END_DOCUMENT) {
				...
				case XmlPullParser.START_TAG:
					if (qName.equals("time")) {
						...
						timeFrom = myParser.getAttributeValue(null, "from");
						timeTo = myParser.getAttributeValue(null, "to");
						
						cityWeatherForecast.setTimeFrom(timeFrom);
						cityWeatherForecast.setTimeTo(timeTo);
